...
// first from environment.API_URL_KARLHERRICK
  ...
  template: `
    <ng-container>
      <article *ngFor="let post of posts">
        <h1><a href="{{buildArticleLink(post.link, 'content.karlherrick.com', 'karlherrick.com')}}">{{ post.title.rendered }}</a></h1>
...
export class KarlHerrickComponent {
  ...
  constructor(private httpClient: HttpClient) {
    this.httpClient.get(environment.API_URL_KARLHERRICK).subscribe((posts: any) => {
