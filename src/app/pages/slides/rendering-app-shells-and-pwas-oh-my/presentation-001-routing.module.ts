...
export const routes: Routes = [
  ...
  },
  {
    path: '29',
    loadComponent: () =>
      import(`./slide.029.component`).then((x) => x.Slide029Component),
  },
  {
    path: '30',
    loadComponent: () =>
      import(`./slide.030.component`).then((x) => x.Slide030Component),
  },
  {
    path: '31',
    loadComponent: () =>
      import(`./slide.031.component`).then((x) => x.Slide031Component),
  },
  {
    path: '32',
    loadComponent: () =>
      import(`./slide.032.component`).then((x) => x.Slide032Component),
  },
  {
    path: '33',
    loadComponent: () =>
      import(`./slide.033.component`).then((x) => x.Slide033Component),
  },
  {
    path: 'end',
    loadComponent: () =>
...
export class Presentation001RoutingModule {}
