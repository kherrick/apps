        ...
        <li quote>
          <blockquote>
            <span>
              ...
              execute much client-side JavaScript, whereas prerendering improves the
              FCP [First Paint or First Contentful Paint] of a Single Page Application
              that must be booted on the client to make pages truly
              interactive.
