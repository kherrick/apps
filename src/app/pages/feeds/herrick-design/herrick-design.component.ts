...
// endpoint: https://herrickdesign.com/wp-json/wp/v2/posts?per_page=2

import initialState from './herrick-design.json';
  ...
  template: `
    <ng-container>
      <article *ngFor="let post of posts">
        <h1>
          <a href="{{ post.link }}" [innerHTML]="trustHtml(post.title.rendered)"></a>
        </h1>
